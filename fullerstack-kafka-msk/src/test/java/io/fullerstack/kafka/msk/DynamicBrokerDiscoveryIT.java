 ...
 * <ul>
 *   <li>Test shouldDetectBrokerAddition: Manually add broker via AWS Console after test starts</li>
 *   <li>Test shouldDetectBrokerRemoval: Manually remove broker via AWS Console after test starts</li>
 * </ul>
 */
class DynamicBrokerDiscoveryIT {
    ...
    void shouldHandleClusterDiscovery() throws Exception {
        ...
        try {
            ...
            // Verify discovery works (sensor creation may fail due to JMX access, that's OK)
