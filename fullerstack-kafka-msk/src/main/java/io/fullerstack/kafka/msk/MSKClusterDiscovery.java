...
public class MSKClusterDiscovery implements AutoCloseable {
    ...
    private String extractBrokerId(String nodeArn) {
        // Extract broker ID from ARN: arn:aws:kafka:region:account:broker/cluster-uuid/broker-id
    ...
    private ClusterConfiguration discoverConfiguration(String configArn) {
        // TODO: Story 5.4 - Read MSK configuration for thresholds
        logger.debug("Using default configuration (Story 5.4 will implement config discovery)");
