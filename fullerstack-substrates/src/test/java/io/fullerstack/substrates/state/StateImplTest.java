...
class StateImplTest {
    ...
    void shouldStoreMultipleValues() {
        ...
        State state = new StateImpl()
            ...
            .state(new LinkedName("name", null), "test")
    ...
    void shouldBeImmutable() {
        ...
        State s2 = s1.state(new LinkedName("count", null), 1);
        State s3 = s2.state(new LinkedName("count", null), 2);
    ...
    void shouldAllowDuplicateNames() {
        ...
        State state = new StateImpl()
            .state(new LinkedName("timeout", null), 30)   // First value
            .state(new LinkedName("retries", null), 3)
            .state(new LinkedName("timeout", null), 60);  // Duplicate name!
    ...
    void shouldCompactRemoveDuplicates() {
        ...
        State state = new StateImpl()
            .state(new LinkedName("timeout", null), 30)   // First value
            .state(new LinkedName("retries", null), 3)
            .state(new LinkedName("timeout", null), 60);  // Override
    ...
    void shouldReturnLastValueWhenDuplicates() {
        Name timeoutName = new LinkedName("timeout", null);
    ...
    void shouldReturnFallbackValueWhenNotFound() {
        ...
        Name missingName = new LinkedName("missing", null);
        State state = new StateImpl()
            .state(new LinkedName("existing", null), 100);
    ...
    void shouldSupportNestedState() {
        ...
        Name dbConfigName = new LinkedName("database", null);

        State innerState = new StateImpl()
            .state(new LinkedName("host", null), "localhost")
            .state(new LinkedName("port", null), 3306);

        State outerState = new StateImpl()
            .state(dbConfigName, innerState)
            .state(new LinkedName("timeout", null), 30);
    ...
    void shouldMatchByBothNameAndType() {
        ...
        Name XYZ = new LinkedName("XYZ", null);
