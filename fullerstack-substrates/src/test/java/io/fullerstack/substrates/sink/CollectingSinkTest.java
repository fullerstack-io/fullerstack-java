...
/**
 * Tests for CollectingSink - validates Sink buffering, draining, and lifecycle.
 */
class CollectingSinkTest {
    ...
    void shouldCreateSinkWithSubject() {
        ...
        // Note: sink name is auto-generated UUID, not a descriptive name
        assertThat(sink.subject().name().value()).isNotEmpty();
    }
